...
//---------------------------------------------------------------------------
  ...
  @FXML private CheckBox chkAutoOpenPDF, chkNewVersionCheck, chkAutoRetrieveBib, chkInternet, chkUseSentenceCase, chkDefaultChapterWorkType, chkLinuxWorkaround,
                         chkCompDontExpandKeyWorks, chkDBDontExpandKeyWorks, chkTermRequireSearchKey, chkPersonSKStartAnchor, chkPersonSKEndAnchor;
...
//---------------------------------------------------------------------------
  ...
  public SettingsDlgCtrlr(SettingsPage page)
  {
    ...
    if (noDB == false)
    {
      ...
      initCheckBox(db.prefs, chkPersonSKStartAnchor , PrefKey.PERSON_SK_START_ANCHOR   , true );
      initCheckBox(db.prefs, chkPersonSKEndAnchor   , PrefKey.PERSON_SK_END_ANCHOR     , false);
