...
//---------------------------------------------------------------------------
  ...
  private final ObjectProperty<BibliographicDate> value;
...
//---------------------------------------------------------------------------
  ...
  public ObjectProperty<BibliographicDate> valueProperty() { return value; }
  public BibliographicDate getDate()                       { return value.get(); }
  public void setDate(BibliographicDate date)              { value.set(date); }
  public void clear()                                      { value.set(BibliographicDate.EMPTY_DATE); }
...
//---------------------------------------------------------------------------
  ...
  private void updateValue(String dayStr, Month month, String yearStr)
  {
    ...
    value.set(new BibliographicDate(parseInt(dayStr, 0), nullSwitch(month, 0, Month::getValue), yearStr, false));
