...
import static org.hypernomicon.view.dialogs.LaunchCommandsDialogController.LaunchCommandTypeEnum.*;
...
public class LaunchCommandsDialogController extends HyperDialog
{
  ...
  @FXML private Label lblAppPathVar;
  @FXML private Label lblFilePathVar;
  @FXML private Label lblPageNumVar;
...
//---------------------------------------------------------------------------
  ...
  public static LaunchCommandsDialogController create(String title, String appPrefKey, String commandsPrefKey, String commandTypePrefKey)
  {
    LaunchCommandsDialogController lcdc = HyperDialog.create("LaunchCommandsDialog.fxml", title, true);
...
//---------------------------------------------------------------------------
  ...
  private void init(String appPrefKey, String commandsPrefKey, String commandTypePrefKey)
  {
    ...
    btnBrowse.setOnAction(event -> OptionsDialogController.browseClick(dialogStage, tfPath));

    taCommands.setText(appPrefs.get(commandsPrefKey, ""));
    tfPath.setText(appPrefs.get(appPrefKey, ""));

    lblAppPathVar.setText(appPathVar);
    lblFilePathVar.setText(filePathVar);
    lblPageNumVar.setText(pageNumVar);
