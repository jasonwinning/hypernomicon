...
public class LockedDialogController extends HyperDialog
{
...
//---------------------------------------------------------------------------
  ...
  public static LockedDialogController create(String title, String otherCompName)
  {
    LockedDialogController ldc = HyperDialog.create("LockedDialog.fxml", title, true);
