...
public class SymbolPickerDlgCtrlr extends HyperDlg
{
...
//---------------------------------------------------------------------------
  ...
  {
    if (instance == null)
      instance = ((SymbolPickerDlgCtrlr)createUsingFullPath("view/mainText/SymbolPickerDlg", "Symbol", false, StageStyle.DECORATED, Modality.NONE)).init();
...
//---------------------------------------------------------------------------
  ...
  {
    chars8851 = ImmutableList.<Symbol>builder()
    ...
    symbols8851 = ImmutableList.<Symbol>builder()
    ...
    math = ImmutableList.<Symbol>builder()
    ...
    greek = ImmutableList.<Symbol>builder()
    ...
    misc = ImmutableList.<Symbol>builder()
