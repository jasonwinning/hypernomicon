...
public final class XmlDiffMain
{

//---------------------------------------------------------------------------
//---------------------------------------------------------------------------

  private XmlDiffMain() { throw new UnsupportedOperationException("Instantiation is not allowed."); }
...
//---------------------------------------------------------------------------
  ...
  public static void main(String[] args)
  {
    ...
    javafx.application.Application.launch(XmlDiffApp.class, args);
  }
