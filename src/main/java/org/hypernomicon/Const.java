...
//---------------------------------------------------------------------------
   ...
   */
  public static final VersionNumber appVersion = new VersionNumber(1, 36);  // 1.36
...
//---------------------------------------------------------------------------
  ...
  public static final class PrefKey
  {
    public static final String
      ...
      PDF_EXTRACTION_TEST_PATH   = "pdfExtractionTestPath",
      PDF_EXTRACTION_TEST_PATH_2 = "pdfExtractionTestPath2",
      PDF_EXTRACTION_TEST_PATH_3 = "pdfExtractionTestPath3",
      LOG_PATH = "logPath",
      HDB_MRU = "hbdMru",
