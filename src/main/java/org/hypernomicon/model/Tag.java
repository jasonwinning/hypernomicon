...
//---------------------------------------------------------------------------
  ...
  tagSpokeRecord     ("spoke"             , "Spoke Record"             , hdtAuxiliary),
  ...
  tagTargetArgument  ("target_argument"   , "Target Argument"          , hdtArgument),
  ...
  tagShortName       ("short_name"        , "Short Name"),
