...
//---------------------------------------------------------------------------
  ...
  @Override public boolean evaluate(int curQuery, HDT_MiscFile miscFile, HyperTableCell op1, HyperTableCell op2, HyperTableCell op3, boolean firstCall, boolean lastCall)
  {
    switch (curQuery)
    {
...
//---------------------------------------------------------------------------
  ...
  @Override public QuerySource getSource(int query, HyperTableCell op1, HyperTableCell op2, HyperTableCell op3)
  {
    ...
    return new DatasetQuerySource(hdtMiscFile);
  }
