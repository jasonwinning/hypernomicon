/*
 *  This file has been modified for inclusion in Hypernomicon by Jason Winning.
 *  Search for the string "Jason Winning" below to see inline changes.
...
var PDFViewerApplication = {
  ...
  error: function error(message, moreInfo) {
    ...
    if (moreInfo) {
      if (moreInfo.message.indexOf("Worker was destroyed" > -1)) return; // [Jason Winning]
    ...
    firstPagePromise.then(function (pdfPage) {
      ...
      Promise.all([storePromise, pageModePromise]).then(function () {
        var _ref10 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee8(_ref9) {
          ...
          var initialBookmark, zoom, page, hash, rotation, sidebarView, scrollMode, spreadMode; // [Jason Winning] add page
            ...
            while (1) {
              switch (_context8.prev = _context8.next) {
                case 0:
                  ...
                  page = _app_options.AppOptions.get('initialPage'); // [Jason Winning]
  ...
  setInitialView: function setInitialView(storedHash) {
    ...
    var _ref13 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        page = _ref13.page, // [Jason Winning]
    ...
    this.pdfViewer.currentPageNumber = page; // [Jason Winning]
      ...
      var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                databaseStr = JSON.stringify(this.database); // [Jason Winning+3] ignore errors
                try {
      ...
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee2(prefObj) {
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                var readPrefs; // [Jason Winning+3] ignore errors
                try {
                  readPrefs = JSON.parse(localStorage.getItem('pdfjs.preferences'));
                } catch (e) { }
                return _context2.abrupt('return', readPrefs);
